sap.ui.define([
		...
		return BaseObject.extend("test.model.ListSelector", {
			 ...
			 * @return {test.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
